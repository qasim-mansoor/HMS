...
public class viewPatientAppointments extends JFrame{
    String headings[] = {"Doctor","Date","Time"};
    ...
    viewPatientAppointments(int pid, String ty)
    {
        ...
        try
        {
            ...
            if(type.equals("p"))
            {
                q = "select bookingid, firstname, lastname, date, slot from bookings natural join staff where patientid = "+patientID;
            }
            else
            {
                q = "select bookingid, firstname, lastname, date, slot from bookings natural join staff";
            }
