...
public class nurseMain extends JFrame implements ActionListener{
...
//    int counter;
    ...
    nurseMain(int sid, String f, String l)
    {
        super("Hospital Management System for Nurses");
...
//        Details.add(p4);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        {
            new viewDoctorAppointments(staffID,"n").setVisible(true);
        }
        else if(msg.equals("Enter Pre-Assessment Results"))
        {
            new uploadPreassessment(staffID).setVisible(true);
        }
